...
void Inventory::addToInv(Player &player, std::vector<std::unique_ptr<Weapon>> &weaponMap, std::vector<std::unique_ptr<Armor>> &armorMap, int weaponID, int armorID, tmx::TileMap& tileMap) {
    if(weaponID > (-1)) {
